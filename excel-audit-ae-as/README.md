...
| Fichier | Rôle |
|---|---|
| `AUDIT.md` | Audit du classeur d'origine, les 11 anomalies et leur correction, détail des livrables |
...
| Historique AE AS | — | 100 % calculé : AE **et** AS fusionnés en une liste continue, triée du plus récent au plus ancien |
...
Trois feuilles sont masquées car techniques : `LOG Agent`, `Objet&TYP` et `Données grilles`
(cette dernière porte les formules sources dont l'historique est la vue triée).
...
attendu **7 663 formules, 0 erreur**.
